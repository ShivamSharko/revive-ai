...
| B2B receivables recovery | `receivables.py`: dispute halt + plan split |
| Mandate expiry assurance | `audit.py` + R-01 |
| Hinglish voice recovery | `voice.py`: ElevenLabs → edge-tts → text |
